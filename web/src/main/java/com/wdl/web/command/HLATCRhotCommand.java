...
//        String pythonPath = "E:/anaconda/envs/pytorch/python.exe";
        ...
        // 第一个脚本路径
        //本地测试
        String scriptPath1 = "E:/anaconda/envs/pytorch/python.exe E:/FTP/web/data/性能测试_hla_tcr.py";

        //服务器
//        String scriptPath1 = "python E:/FTP/web/data/性能测试_hla_tcr.py";
        String command1 =  scriptPath1;

        // 第二个脚本路径
        //本地测试
        String scriptPath2 = "E:/anaconda/envs/pytorch/python.exe E:/FTP/web/data/热图_hla_tcr.py";

        //服务器
//        String scriptPath2 = "python E:/FTP/web/data/热图_hla_tcr.py";
